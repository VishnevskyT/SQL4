CREATE DATABASE ShopDB;				-- Используя JOIN’s и ShopDB получить имена покупателей и имена сотрудников у которых TotalPrice товара больше 1000
...
/* !!!!!!нижче створення таблиця ShopDB (скопійовано з лекційних матеріалів)!!!!!!*/
